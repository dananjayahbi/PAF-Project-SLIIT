...
import { Form, Button, Row, Col, message, Input, Divider } from "antd";
...
const Login = () => {
  ...
  const handleGitHubLogin = () => {
    window.location.href =
      "https://github.com/login/oauth/authorize?client_id=542da6b091d6a0d087bb&scope=user";
  };
        ...
        >
          ...
          >
            ...
            >
              ...
              <Form.Item style={{ display: "flex", justifyContent: "center" }}>
                <Button icon={<GithubOutlined />} type="primary" onClick={handleGitHubLogin}>
                  Login with GitHub
                </Button>
              </Form.Item>
            </Form>
